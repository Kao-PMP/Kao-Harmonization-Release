...
var createFunctionChoiceModule = function(callback) {
    ...
    function _build_function_choices(json_list) {
        ...
        //console.log("function_choice._build_function_choices()" + JSON.stringify(json_list))
    ...
    function do_function_choices(study_id) {
        var study_id=get_checked_radio_button("fcm_study_choice"); // CHRIS modulaaritzaiton
