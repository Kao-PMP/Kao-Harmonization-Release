...
# deprecated, this is the old python functions
#class OhdsiMappingFunction(models.Model):
#    ohdsi_mapping_function_id = models.IntegerField(primary_key=True)
#    function_name = models.CharField(max_length=100, blank=True, null=True)
#    study = models.ForeignKey('Study', models.DO_NOTHING, blank=True, null=True)
...
#    class Meta:
#        managed = False
#        db_table = 'study_to_ohdsi_mapping_function'

# these are python too, but data-driven
class StudyToOhdsiMappingFunction(models.Model):
    study_id = models.IntegerField(blank=True, null=True)
    from_table = models.CharField(max_length=100, blank=True, null=True)
    from_column = models.CharField(max_length=100, blank=True, null=True)
    function_name = models.CharField(max_length=100, blank=True, null=True)
    vocabulary_id = models.CharField(max_length=100, blank=True, null=True)
    concept_code = models.CharField(max_length=1000, blank=True, null=True)
    from_int = models.IntegerField(blank=True, null=True)
    from_value = models.CharField(max_length=100, blank=True, null=True)
    to_concept = models.CharField(max_length=100, blank=True, null=True)
