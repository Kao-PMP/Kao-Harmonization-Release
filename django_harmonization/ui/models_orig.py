...
class CategorizationFunctionMetadata(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('study_id', 'function_name', 'long_name', 'rule_id'), ('study_id', 'function_name', 'long_name', 'rule_id'),)
...
class CategorizationFunctionQualifiers(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('study_id', 'function_name', 'long_name', 'rule_id', 'vocabulary_id', 'concept_code'),)
...
class CategorizationFunctionTable(models.Model):
    ...
    from_vocabulary_id = models.CharField(max_length=100, blank=True, null=True)
...
class EventsMapping(models.Model):
    ...
    from_column = models.CharField(max_length=50, blank=True, null=True)
    ...
    where_clause = models.CharField(max_length=256, blank=True, null=True)
    comment = models.CharField(max_length=256, blank=True, null=True)
...
class ExtractStudy(models.Model):
    extract_study_id = models.IntegerField(blank=True, null=True)
    study_id = models.IntegerField(blank=True, null=True)
...
class OhdsiCalculationArgument(models.Model):
    ...
    to_vocabulary_id = models.CharField(max_length=100)
    from_table = models.CharField(max_length=100, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'ohdsi_calculation_argument'
        unique_together = (('study_id', 'function_name', 'to_concept_code', 'to_vocabulary_id', 'vocabulary_id', 'concept_code'),)
...
class OhdsiCalculationFunction(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('study_id', 'function_name', 'to_concept_code', 'to_vocabulary_id'),)
...
class StudyToOhdsiMapping(models.Model):
    ...
    function_name = models.CharField(max_length=100, blank=True, null=True)
    vocabulary_id = models.CharField(max_length=100, blank=True, null=True)
