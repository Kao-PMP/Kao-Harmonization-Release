...
# command line test for REST APIs
# curl -H "Authorization: Token fa392aa886cad716b3e32e02256d4ef0e80b3080"  http://localhost:8000/ui/get_all_studies/
# command line to get token, if already established by below line
# curl -X GET -d "username=croeder&password=fartfart" http://localhost:8000/ui/api-token-auth/
# create the token by:
# python manage.py drf_create_token croeder
...
urlpatterns = [
    ...
    # STOM: study_to_ohdsi_mapping
    # used? ...this is a form
    url(r'^study_to_ohdsi_mapping_function/$', 
        views.study_to_ohdsi_mapping_function, name='study_to_ohdsi_mapping_function'),
    ...
    url(r'^harmonization_sheet/$', 
        TemplateView.as_view(template_name='harmonization_sheet.html'), name='harmonization_sheet'),
        #views.harmonization_sheet, name='harmonization_sheet'),
    url(r'^index.html$', 
